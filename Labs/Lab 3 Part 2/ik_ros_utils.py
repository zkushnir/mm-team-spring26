...
def get_current_configuration(joint_state):
    ...
    # The four prismatic arm segments (l0-l3) extend together as one telescoping unit.
    # joint_states_callback only subscribes to joint_arm_l0, which already represents
    # 1/4 of the total extension — use it directly for all four chain links.
